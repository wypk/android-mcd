...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private AppCompatTextView mStateTv; // TextView to expand/collapse
    ...
    private void findViews() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            mTv.setJustificationMode(JUSTIFICATION_MODE_INTER_WORD);
        }
        ...
        switch (mStateTvGravity) {
            case STATE_TV_GRAVITY_LEFT:
                params.gravity = Gravity.START;
                break;
            case STATE_TV_GRAVITY_CENTER:
                params.gravity = Gravity.CENTER_HORIZONTAL;
                break;
            case STATE_TV_GRAVITY_RIGHT:
